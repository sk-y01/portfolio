      ...
      case "소개":
        return (
          <div className="aboutMe">
            ...
            <p>프론트엔드 개발자 이하늘입니다. <br/> 새로운 것을 배우고 직접 적용해보는 과정을 좋아합니다. <br/> 작은 시도라도 꾸준히 쌓이다 보면 결국 성장으로 이어진다고 믿습니다.  <br/> 경영학을 전공하며 마케팅과 홍보 활동을 통해  <br/> 정보를 보기 쉽게 정리하고, 사람들에게 전달하는 법을 배웠습니다.  <br/> 이 과정에서 자연스럽게 협업과 책임감을 익혔고, <br/> 그 경험이 지금의 개발 공부에도 큰 도움이 되고 있습니다. <br/> 앞으로도 배우는 걸 멈추지 않으며, <br/> 더 나은 방향으로 나아가는 개발자가 되겠습니다.</p>
          </div>
        );
