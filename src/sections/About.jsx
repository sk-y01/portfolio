      ...
      case "소개":
        return (
          <div className="aboutMe">
            ...
            <p>프론트엔드 개발자 <strong>이하늘</strong>입니다. <br/> 
            새로운 것을 배우고 적용하는 과정을 즐기며,<br/> 
            작은 시도라도 꾸준히 쌓이는 경험이 저를 <strong>성장</strong>시킨다고 믿습니다.<br/>
            경영학을 전공하며 넓은 시야로 문제를 바라보는 습관을 길렀고,<br/> 
            다양한 활동을 통해 문서 작성과 협업 능력을 키워왔습니다.<br/> 
            사용자의 입장에서 더 나은 경험을 만드는 개발자를 지향하며,<br/> 
            변화 속에서도 꾸준히 성장해 오늘보다 나은 내일을 만들어가고 있습니다.</p>
          </div>
        );
